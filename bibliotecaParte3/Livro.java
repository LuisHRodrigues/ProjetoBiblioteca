...
public class Livro extends Obra {
    ...
    public Livro(String titulo, String autor, int ano, String area, String editora, int edicao, int numeroDeFolhas, boolean reserva) {
	...
	public String toString() {
		return " Editora= " + editora + ", edicao= " + edicao + ", numeroDeFolhas= " + numeroDeFolhas
